...
const TABLE_COLUMNS = {
  package_configs: new Set([
    ...
    'pricing_availability', 'currency', 'deliverables_label', 'bonuses_label', 'show_bonuses',
    ...
    'commitment_discount_enabled', 'commitment_discount_percent', 'commitment_discount_label',
    'commitment_discount_prices',
    'cost_data',
    'manual_status',
  ...
  contracts: new Set([
    ...
    'custom_button_label', 'custom_button_link', 'consent_text', 'intro_message', 'status',
  ...
  contract_templates: new Set([
    ...
    'logo_url', 'logo_height', 'accent_color', 'custom_confirmation_message',
    'custom_button_label', 'custom_button_link', 'intro_message',
    'created_at', 'updated_at',
  ]),
